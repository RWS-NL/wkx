...
Polygon.prototype.toGeoJSON = function (options) {
	...
	if (this.exteriorRing.length > 0) {
		...
		for (var i = 0; i < this.exteriorRing.length; i++) {
			if (this.hasZ) exteriorRing.push([this.exteriorRing[i].x, this.exteriorRing[i].y, this.exteriorRing[i].z]);
	...
	for (var j = 0; j < this.interiorRings.length; j++) {
		...
		for (var k = 0; k < this.interiorRings[j].length; k++) {
			if (this.hasZ) interiorRing.push([this.interiorRings[j][k].x, this.interiorRings[j][k].y, this.interiorRings[j][k].z]);
